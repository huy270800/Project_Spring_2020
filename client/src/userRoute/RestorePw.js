...
export default function RestorePw(props) {
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.instruction} >Please enter your email.<br/> Your account name and a link to restore your PW will be send to your email. </div>
            <form onSubmit={ restorePw }>
                <div>
                    E-mail: <input className={styles.textfield} type="email" name="email" />
                </div>
                <div>
                    Reset Password: <button className={styles.button} type="submit">Confirm</button>
                </div>
            </form>
            <div>
                You remember your account? &nbsp; <Link to='/user/login' > <button className={styles.button} > log in </button> </Link>
            </div>
        </div>
    )
}
