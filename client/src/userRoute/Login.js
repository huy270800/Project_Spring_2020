    ...
    return (
        <div className={styles.container}>
            ...
            <form onSubmit={ authUser }>
                ...
                <div>
                    Log in: <button className={styles.button} type="submit">Login</button>
                </div>
            </form>
            <div>
                You don't have an account? &nbsp; <Link to='/user/register' > <button className={styles.button} > create account </button> </Link>
            </div>
            <div>
                You forgot your account? &nbsp; <Link to='/user/restorePw' > <button className={styles.button} > reset password </button> </Link>
            </div>
